...
class IdrisDataset(ReadingDataset):
    ...
    def read_mask(self, fn):
        path = os.path.join(self.root, 'ma_masks', os.path.splitext(fn)[0] + '_MA.tif')
